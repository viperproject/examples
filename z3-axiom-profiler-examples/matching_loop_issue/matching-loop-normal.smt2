(get-info :version)
; (:version "4.4.2")
; Input file is matching_loop_issue_normal.sil
; Started: 2015-11-06 10:25:01
...
(assert (forall (($p1 $Process) ($p2 $Process) ($p3 $Process)) (!
  ...
  :pattern ((p_seq<Process~Process~Process> $p1 $p2) (p_seq<Process~Process~Process> $p2 $p3))
  :pattern ((p_seq<Process~Process~Process> $p1 $p2) (p_seq<Process~Process~Process> $p1 (p_seq<Process~Process~Process> $p2 $p3)))
